...
public class VeterinaryClinicBody extends JPanel {
    ...
    private void addAppointmentsTable() {
        ...
        String[] columnNames = {
                "ID.Cita", "Fecha", "Mascota", "Especie", "Responsable"
        };
    ...
    public void addAppointment(Appointment appointment) {
        Object[] appointmentData = { appointment.getId(), appointment.getDate().toString(),
                appointment.getPet().getName(), appointment.getPet().getBreed(),
                this.searchPersonByid(appointment.getKeeper().getPersonId()).getName()
                        + appointment.getKeeper().getRelationship() };
